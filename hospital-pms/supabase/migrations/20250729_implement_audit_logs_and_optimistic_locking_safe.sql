-- ============================================
-- Comprehensive Audit Log and Optimistic Locking Implementation (Safe Version)
-- ============================================

-- 1. Drop existing audit_logs table and recreate with new structure
-- ============================================
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'audit_logs') THEN
    ...
    RAISE NOTICE 'audit_logs table exists. Dropping and recreating...';
    
    -- Drop dependent objects first
    DROP VIEW IF EXISTS audit_activity_summary CASCADE;
    DROP VIEW IF EXISTS audit_statistics CASCADE;
    DROP FUNCTION IF EXISTS get_audit_history CASCADE;
    DROP FUNCTION IF EXISTS restore_record_version CASCADE;
    
    -- Drop existing policies
    DROP POLICY IF EXISTS "Admin and managers can view audit logs" ON audit_logs;
...
-- 3. Create or replace function to get changed fields between two JSONB objects
-- ============================================
...
-- 4. Create or replace comprehensive audit trigger function
-- ============================================
...
-- 5. Create or replace optimistic lock check function
-- ============================================
...
SELECT 
  ...
  CASE 
    ...
    WHEN al.table_name = 'profiles' THEN pr.name
    ELSE NULL
  END as record_name
FROM audit_logs al
